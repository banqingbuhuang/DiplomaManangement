(function (window) {
    ...
    class VerifySlide {
      ...
      bindEvents() {
        ...
        this.refreshIcon.onclick = () => {
          this.reset();
           var onRefresh = (typeof this.onRefresh === 'function') && this.onRefresh();
        };
        ...
        document.addEventListener('mouseup', (e) => {
          ...
          if (spliced) {
            if (TuringTest) {
              ...
              var onSuccess =  (typeof this.onSuccess === 'function') && this.onSuccess();
            } else {
            ...
            addClass(this.sliderContainer, 'sliderContainer_fail');
            var onFail = (typeof this.onFail === 'function') && this.onFail();
            setTimeout(() => {
              this.reset();
            }, 2000);
          }
    ...
    window.VerifySlider = {
      init: function (opts) {
        var verify = new VerifySlide(opts).init();
        return verify;
      }
    };
  }(window));
